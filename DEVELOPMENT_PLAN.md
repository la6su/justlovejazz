...
- [ ] **Smart Asset Loading**: Система динамической загрузки/выгрузки текстур высокого разрешения в зависимости от активного проекта.
- [ ] **Texture Compression**: Переход на сжатые форматы текстур для уменьшения нагрузки на VRAM.
