...
| [0003](0003-unify-webgpu-webgl2-renderer.md)    | Superseded             | Historical proposal for one WebGPURenderer              |
...
| [0010](0010-close-unified-renderer-decision.md) | Accepted with evidence | Ship one WebGPURenderer with WebGPU/WebGLBackend policy |
