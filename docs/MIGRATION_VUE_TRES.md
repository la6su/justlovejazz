...
| migration flags and shims                | Phase 10 — the dev-forced `?renderer=webgl` flag + classic factory removed in slice 2 2026-08-22; the raw `jlz:*` window bridge (tracked on its own row) is the remaining shim                                                                                                                                                                                                                                                                                                                                                | pending |
