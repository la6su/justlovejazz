...
// The ink stage reads the shared Input singleton; stub its mouse so pointer
...
describe('ManifestoInkStage lifecycle', () => {
  beforeEach(() => {
  ...
  it('drifts the ink focus toward the pointer with reading-page damping and decays energy at rest', () => {
    const stage = new ManifestoInkStage()
    stage.setActive(true)
  ...
  it('matches the manifesto ink on either theme and ignores late mutations', () => {
    const stage = new ManifestoInkStage()
    stage.setTheme(true)
