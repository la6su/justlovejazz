...
const emailSection = sectionShell('contact-01',
  contentTop('01', 'Email', 'Direct line.', 'large'),
  contentBottom(`
...
const socialSection = sectionShell('contact-02',
  contentTop('02', 'Social', 'Find us elsewhere.', 'large'),
  contentBottom(`
...
const locationSection = sectionShell('contact-03',
  contentTop('03', 'Location', 'Where we work.', 'large'),
  contentBottom(`
    <div class="jlz-service-desc uk-margin-small-top">
      <p class="uk-text-meta uk-margin-remove">Remote · EU · since 2019</p>
      <p class="uk-text-meta uk-margin-remove">Open for new projects.</p>
    </div>
  `)
)
...
const formSection = sectionShell('contact-04',
  contentTop('04', 'Form', 'Tell us about your project.', 'large'),
  contentBottom(`
    <form class="jlz-contact-form uk-flex uk-flex-center uk-flex-middle uk-margin-bottom" action="mailto:hello@justlovejazz.com" method="post" enctype="text/plain">
      <div class="uk-inline uk-width-1-1 uk-width-medium@s">
        ...
        <input class="uk-input" type="text" name="subject" placeholder="What's the project?" aria-label="Project subject" />
      </div>
