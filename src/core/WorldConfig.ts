...
// 8 sections (6 main + 2 secret side: Lab=0, Process=7)
// Index: 0=lab, 1=intro, 2=about, 3=flexible, 4=challenge, 5=innovative, 6=contact, 7=process
const RAW: RawScene[] = [
  ...
  // ── Section 7: PROCESS (secret right) — Dark BG, workflow timeline ──
  {
    id: 'sec_process',
