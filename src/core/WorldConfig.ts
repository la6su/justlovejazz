...
const RAW: RawScene[] = [
  { id: 'step01', camPos: [0,0,8], camTarget: [0,0,0], camFov: 55, bakuRole: BakuRole.NORMAL, bakuOpacity: 1, bakuColor: 0x111111, bakuEmissive: 0x020202, postBloom: 0.2, postVignette: 0.7, postGrain: 0.03, lightColor: 0x030308, lightIntensity: 0.8, fogColor: 0x030308, fogDensity: 0.03, postChromatic: 0.005, bgColor: 0x050507, camFovOffset: 0.3, camFovDuration: 0.8, camSmoothing: 5 },
  { id: 'step02', camPos: [-4,2,6], camTarget: [0,0,0], camFov: 65, bakuRole: BakuRole.WIRE, bakuOpacity: 0.6, bakuColor: 0x111111, bakuEmissive: 0x020202, postBloom: 0.3, postVignette: 0.5, postGrain: 0.025, lightColor: 0x040302, lightIntensity: 1, fogColor: 0x040302, fogDensity: 0.025, postChromatic: 0.005, bgColor: 0x0a0a0f, camFovOffset: 0.4, camFovDuration: 0.9, camSmoothing: 4 },
  { id: 'step03', camPos: [0,1,7], camTarget: [0,1,0], camFov: 50, bakuRole: BakuRole.WIRE, bakuOpacity: 0.4, bakuColor: 0x111111, bakuEmissive: 0x020202, postBloom: 0.4, postVignette: 0.4, postGrain: 0.02, lightColor: 0x030305, lightIntensity: 1.2, fogColor: 0x030305, fogDensity: 0.02, postChromatic: 0.005, bgColor: 0x080810, camFovOffset: 0.5, camFovDuration: 1.0, camSmoothing: 6 },
  { id: 'step04', camPos: [0,1,7], camTarget: [0,1,0], camFov: 50, bakuRole: BakuRole.NORMAL, bakuOpacity: 0.2, bakuColor: 0x111111, bakuEmissive: 0x020202, postBloom: 0.15, postVignette: 0.6, postGrain: 0.04, lightColor: 0x020204, lightIntensity: 0.6, fogColor: 0x020204, fogDensity: 0.04, postChromatic: 0.005, bgColor: 0x030308, camFovOffset: 0.2, camFovDuration: 0.7, camSmoothing: 3 },
