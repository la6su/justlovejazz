...
const RAW: RawScene[] = [
  { id: 'step01', camPos: [0,0,8], camTarget: [0,0,0], camFov: 55, bakuRole: BakuRole.NORMAL, bakuOpacity: 1, bakuColor: 0x111111, bakuEmissive: 0x020202, postBloom: 0.2, postVignette: 0.7, postGrain: 0.03, lightColor: 0x050810, lightIntensity: 0.8, fogColor: 0x050810, fogDensity: 0.03, postChromatic: 0.005, bgColor: 0x050507, camFovOffset: 0.3, camFovDuration: 0.8, camSmoothing: 5 },
  { id: 'step02', camPos: [-4,2,6], camTarget: [0,0,0], camFov: 65, bakuRole: BakuRole.WIRE, bakuOpacity: 0.6, bakuColor: 0x111111, bakuEmissive: 0x020202, postBloom: 0.3, postVignette: 0.5, postGrain: 0.025, lightColor: 0x080812, lightIntensity: 1, fogColor: 0x080812, fogDensity: 0.025, postChromatic: 0.005, bgColor: 0x08080c, camFovOffset: 0.4, camFovDuration: 0.9, camSmoothing: 4 },
