...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  EN: {
    ...
    'contact.email.copy': 'A clear first sentence is enough to start.',
    'contact.email.meta': 'For new work, questions and good ideas.',
    'contact.social.title': 'Social',
    'contact.social.lead': 'Find us elsewhere.',
    'contact.social.copy': 'Choose the channel that fits the conversation.',
    ...
    'contact.location.copy': 'A quiet base in the Troodos mountains.',
    ...
    'contact.form.copy': 'When the next move needs care, let’s make it together.',
  ...
  RU: {
    ...
    'contact.email.copy': 'Одной ясной фразы достаточно, чтобы начать.',
    ...
    'contact.social.copy': 'Выберите канал, который подходит разговору.',
    ...
    'contact.location.copy': 'Тихая база в горах Троодос.',
    ...
    'contact.form.copy': 'Если следующий шаг требует внимания, сделаем его вместе.',
