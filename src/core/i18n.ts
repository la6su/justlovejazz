...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  EN: {
    ...
    "works.room1.context": "An exploration of sound, spatial rhythm and an interface that gives music room to breathe.",
    "works.room2.premise": "How little can an experience need?",
    "works.room2.context": "A study in restraint. Texture and silence carry the identity; interaction leaves the composition intact.",
    "works.room3.premise": "Give the invisible a sense of depth.",
    "works.room3.context": "A particle-led study of ambient frequencies, liquid light and the boundary between image and space.",
    "works.room4.premise": "Every finished idea begins as an experiment.",
    "works.room4.context": "An open archive of visual music, procedural surfaces and spatial sketches. Select a fragment to explore.",
  ...
  RU: {
    ...
    "works.room1.context": "Исследование звука, пространственного ритма и интерфейса, который оставляет музыке воздух.",
    "works.room2.premise": "Как мало нужно, чтобы почувствовать?",
    "works.room2.context": "Этюд о сдержанности. Фактура и тишина создают характер, а взаимодействие сохраняет композицию.",
    "works.room3.premise": "Придать невидимому глубину.",
    "works.room3.context": "Частицы, текучий свет и эмбиентные частоты. Исследование границы между изображением и пространством.",
    "works.room4.premise": "Каждая идея начинается с эксперимента.",
    "works.room4.context": "Открытый архив визуальной музыки, процедурных поверхностей и пространственных этюдов. Выберите фрагмент.",
