...
export class AssetManager {
  ...
  private contextGroups: Map<
    string,
    Set<THREE.Object3D | THREE.Texture | THREE.Material | THREE.BufferGeometry>
  > = new Map()
  ...
  private hasDispose(
    asset: THREE.Object3D | THREE.Texture | THREE.Material | THREE.BufferGeometry,
  ): asset is (THREE.Object3D | THREE.Texture | THREE.Material | THREE.BufferGeometry) & {
    dispose: () => void
  } {
