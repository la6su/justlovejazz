  ...
  import('./entry-app')
    ...
    .catch((err) => {
      ...
      fallback.innerHTML =
        ...
        '<button onclick="location.reload()" style="background:none;border:1px solid rgba(255,255,255,0.3);color:#fff;padding:8px 24px;cursor:pointer;font-size:12px;text-transform:uppercase;">Reload</button>'
